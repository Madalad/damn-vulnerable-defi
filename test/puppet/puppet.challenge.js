...
describe("[Challenge] Puppet", function () {
    ...
    it("Exploit", async function () {
        ...
        /*
        To reduce deposit amount, alter balances of uniswapExchange:
            - minimise ether
            - maximise token
        => swap max tokens for ether
        Then deposit reduced amount to steal all 1,000,000 tokens
        */
        ...
        // Get new deposit needed (19.7 ETH)
        const deposit = await this.lendingPool.calculateDepositRequired(POOL_INITIAL_TOKEN_BALANCE)

        // Drain all funds with less ether than expected
